...
export const BUILTIN_TEMPLATES = [
  {
    ...
    ex: [
      { n: "Выпрыгивания с гантелей", s: [[12,5],[12,5],[12,5],[12,5]] },
      { n: "Жим штанги лёжа", s: [[60,8],[70,5],[70,5,"4–5"],[70,4]] },
      { n: "Разведение гантелей лёжа", s: [[14,10],[14,10],[14,11,"10–12"]] },
      { n: "Подтягивания", s: [[0,6,"б/п"],[0,6,"5–6 б/п"],[14,9,"помощь 8–10"]] },
      { n: "Махи гантелей в стороны", s: [[9,12],[9,12],[9,11,"10–12"]] },
      { n: "Подъём штанги на бицепс", s: [[20,10],[20,10],[17.5,10]] },
  ...
  },
  {
    ...
    ex: [
      { n: "Подъём на носки в тренажёре сидя", s: [[20,15],[20,15],[25,12]] },
      { n: "Жим гантелей на скамье 15°", s: [[22,10],[22,10],[22,10,"9–10"]] },
      { n: "Тяга вертикального блока к груди", s: [[45,12],[45,12],[45,10]] },
      { n: "Брусья", s: [[0,12,"б/п"],[0,9,"8–10 б/п"],[9,9,"помощь 9–10"]] },
      { n: "Жим гантелей сидя", s: [[16,10],[16,10],[16,10,"9–10"]] },
      { n: "Разгибание на трицепс на блоке (канат)", s: [[11.3,12],[11.3,12],[13.5,9,"8–10"]] },
      { n: "Скручивания в тренажёре", s: [[0,12],[0,12],[0,12]] },
    ],
  },
  {
    id: "h2t1", name: "Н2 · Т1", sub: "Грудь / спина / руки", builtin: true,
    ex: [
      { n: "Приседания с гантелью (гоблет)", s: [[26,8],[26,8],[26,8],[26,8]] },
      { n: "Жим гантелей на скамье 15°", s: [[22,10],[24,8],[24,8]] },
      { n: "Сведение рук в тренажёре", s: [[15,12],[15,11,"10–12"],[15,11,"10–12"]] },
      { n: "Подтягивания", s: [[0,8,"б/п"],[0,5,"б/п"],[14,9,"помощь 8–10"]] },
      { n: "Тяга штанги к подбородку", s: [[25,10],[25,10],[25,9,"8–10"]] },
      { n: "Подъём гантелей хватом «молот»", s: [[10,10],[10,10],[7.5,10]] },
      { n: "Подъём ног в висе", s: [[0,null],[0,null],[0,null]] },
    ],
  },
  {
    id: "h2t2", name: "Н2 · Т2", sub: "Ноги / плечи / руки", builtin: true,
    ex: [
      { n: "Подъём на носки в тренажёре сидя", s: [[20,15],[25,12],[25,12]] },
      { n: "Жим в тренажёре сидя на грудь", s: [[30,10],[30,10],[32.5,9,"8–10"]] },
      { n: "Тяга горизонтального блока к поясу", s: [[45,10],[45,10],[50,9,"8–10"]] },
