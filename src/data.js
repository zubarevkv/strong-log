 ...
 * Применяется на клиенте при сейве и зеркалится на бэкенде
 * (api/lib/Canon.php) при POST /sessions, /import и сидинге БД.
 * При правке словаря держать обе карты в синхроне — соответствие
 * проверяет scripts/check-canon.php. Спорные слияния — HANDOFF.md §5. */
export const CANON = {
