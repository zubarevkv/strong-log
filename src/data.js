...
export const BUILTIN_TEMPLATES = [
  {
    id: "h1t1", name: "Н1 · Т1", sub: "Тяжёлый жим · бицепс", builtin: true,
    ex: [
      { n: "Атакующий разбег с резиной (контраст)", s: [[0,3],[0,3],[0,3],[0,3]] },
      { n: "Свободный атакующий прыжок", s: [[0,1],[0,1],[0,1],[0,1]] },
      { n: "Жим штанги лёжа", s: [[20,12],[50,5],[60,3],[80,4],[70,7],[70,7]] },
      { n: "Разведение гантелей лёжа", s: [[16,12],[16,12],[16,12]] },
      { n: "Болгарский сплит-присед с гантелями", s: [[6,6],[12,6],[12,6],[12,6]] },
      { n: "Сгибание ног в тренажёре сидя", s: [[40,8],[40,8],[40,8]] },
      { n: "Подтягивания", s: [[0,8],[0,8],[0,8]] },
      { n: "Обратная бабочка в тренажёре", s: [[15,8],[15,8]] },
      { n: "Жим гантелей сидя", s: [[18,12],[18,12],[18,12]] },
      { n: "Подъём штанги на бицепс", s: [[25,10],[25,10],[25,10]] },
      { n: "Мёртвый жук с сопротивлением", s: [[10,10],[10,10]] },
    ],
  },
  {
    id: "h1t2", name: "Н1 · Т2", sub: "Наклонная · трицепс", builtin: true,
    ex: [
      { n: "Пружинные прыжки на носках", s: [[0,10],[0,10],[0,10]] },
      { n: "Броски мед-мяча в пол (2 руки)", s: [[3,6],[3,6],[3,6],[3,6]] },
      { n: "Жим гантелей на скамье 15°", s: [[24,12],[24,12],[24,12]] },
      { n: "Брусья", s: [[-10,8],[-10,8],[-10,8]] },
      { n: "Жим ногами", s: [[60,8],[90,5],[120,6],[120,6],[120,6]] },
      { n: "Ягодичный мост", s: [[40,10],[70,10],[70,10],[70,10]] },
      { n: "Тяга горизонтального блока к поясу", s: [[55,12],[55,12],[55,12]] },
      { n: "Обратная бабочка в тренажёре", s: [[15,8],[15,8]] },
      { n: "Махи гантелей в стороны", s: [[12,12],[12,12],[12,12]] },
      { n: "Разгибание на трицепс на блоке (канат)", s: [[15,12],[15,12]] },
      { n: "Паллоф-жим", s: [[0,10],[0,10]] },
    ],
  },
  {
    id: "h2t1", name: "Н2 · Т1", sub: "Объёмный жим · бицепс", builtin: true,
    ex: [
      { n: "Атакующий разбег с резиной (контраст)", s: [[0,3],[0,3],[0,3],[0,3]] },
      { n: "Свободный атакующий прыжок", s: [[0,1],[0,1],[0,1],[0,1]] },
      { n: "Жим штанги лёжа", s: [[20,12],[50,5],[70,8],[70,8],[70,8]] },
      { n: "Жим в тренажёре сидя на грудь", s: [[35,10],[35,10],[35,10]] },
      { n: "Болгарский сплит-присед с гантелями", s: [[6,6],[12,6],[12,6],[12,6]] },
      { n: "Сгибание ног в тренажёре сидя", s: [[40,8],[40,8],[40,8]] },
      { n: "Тяга вертикального блока к груди", s: [[55,10],[55,10],[55,10]] },
      { n: "Обратная бабочка в тренажёре", s: [[15,8],[15,8]] },
      { n: "Жим гантелей сидя", s: [[18,12],[18,12],[18,12]] },
      { n: "Подъём гантелей хватом «молот»", s: [[10,10],[10,10],[10,10]] },
      { n: "Мёртвый жук с сопротивлением", s: [[10,10],[10,10]] },
    ],
  },
  {
    id: "h2t2", name: "Н2 · Т2", sub: "Наклонная · трицепс", builtin: true,
    ex: [
      { n: "Пружинные прыжки на носках", s: [[0,10],[0,10],[0,10]] },
      { n: "Броски мед-мяча в пол (2 руки)", s: [[3,5],[3,5],[3,5]] },
      { n: "Жим гантелей на скамье 15°", s: [[24,12],[24,12],[24,12]] },
      { n: "Сведение рук в тренажёре", s: [[15,12],[15,12],[15,12]] },
      { n: "Жим ногами", s: [[60,8],[90,5],[120,6],[120,6],[120,6]] },
      { n: "Ягодичный мост", s: [[40,10],[70,10],[70,10],[70,10]] },
      { n: "Тяга горизонтального блока к поясу", s: [[55,12],[55,12],[55,12]] },
      { n: "Обратная бабочка в тренажёре", s: [[15,8],[15,8]] },
      { n: "Махи гантелей в стороны", s: [[12,12],[12,12],[12,12]] },
      { n: "Разгибание на трицепс на блоке (прямая рукоять)", s: [[15,10],[15,10],[15,10]] },
      { n: "Паллоф-жим", s: [[0,10],[0,10]] },
    ],
  },
];
...
export const CANON = {
  ...
  // ноги / ягодичные — короткие имена новой программы (старые длинные → новый канон, история сохраняется)
  "Жим ногами в тренажёре": "Жим ногами",
  "Ягодичный мост в тренажёре": "Ягодичный мост",
  "Ягодичный мост в тренажере": "Ягодичный мост",
};
